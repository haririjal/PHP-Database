...
<div class="container">
  <h1 align="center">Update Data</h1>
    ...
    Gender: <br><input type="radio" name="gender" <?php if($arr['gender']=="Male") { echo "checked"; }?>  value="Male"> Male 
  <input type="radio" name="gender" <?php if($arr['gender']=="Female") { echo "checked"; }?>  value="Female"> Female <br>
